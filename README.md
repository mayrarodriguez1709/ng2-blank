...
This repository holds the TypeScript source code of the [angular.io quickstart](https://angular.io/docs/ts/latest/quickstart.html) but
just with the necessary dependencies, the foundation for most of the documentation samples and potentially a good starting point for your application.
...
We have no intention of updating the source on `mayrarodriguez1709/ng2-blank`.
